...
const PROFILE_IMAGE_URL = 'https://avatars2.githubusercontent.com/u/28197080?s=400&u=b72f8e7d02d0c33981bb5caea711c068ad70a5d8&v=4';
  ...
  <Container>
    ...
    >
      <Content>
        ...
        <NameTextWrapper>
          <NameText>Martin Jham</NameText>
        </NameTextWrapper>
        <SubTextWrapper>
          <SubText>Front End Developer & DevOps </SubText>
          <HeartBeating />
        </SubTextWrapper>
        ...
        <AboutMeWrapper>
          ...
          <AboutMeDescription>
            {
              'A Full Stack Engineer with interests in the Javascript world, including NodeJS and, obviously, the React Ecossystem (ReactJS And React-Native ).\n\n Every person has some strengths, even if we don’t always see them'
            }
          </AboutMeDescription>
        </AboutMeWrapper>
      </Content>
